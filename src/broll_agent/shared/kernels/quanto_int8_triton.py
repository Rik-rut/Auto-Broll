...
_AUTOTUNE_DEBUG_OVERRIDE: bool | None = None
...
def set_autotune_debug(enabled: bool | None = None) -> None:
...
def _normalize_config(cfg) -> tuple[int, int, int, int, int] | None:
...
def _device_index(device: torch.device | None) -> int:
...
def _get_cached_config(device_index: int, kernel_kind: str, slot_id: str, m: int, k: int, n: int) -> tuple[int, int, int, int, int] | None:
    global _AUTOTUNE_CACHE_DIRTY
...
def _run_candidate_once(kind: str, cfg: tuple[int, int, int, int, int], tensors: tuple[torch.Tensor, ...], m: int, k: int, n: int) -> torch.Tensor | None:
...
) -> tuple[tuple[int, int, int, int, int], Exception | None]:
...
def _benchmark_config_ms(kind: str, cfg: tuple[int, int, int, int, int], tensors: tuple[torch.Tensor, ...], device: torch.device, m: int, k: int, n: int) -> float | None:
